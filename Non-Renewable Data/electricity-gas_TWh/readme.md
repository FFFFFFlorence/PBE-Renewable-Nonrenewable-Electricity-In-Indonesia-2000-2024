# Electricity generation from gas - Data package

This data package contains the data that powers the chart ["Electricity generation from gas"](https://ourworldindata.org/grapher/electricity-gas?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on December 13, 2025.
...
#### Full citation
Ember (2025); Energy Institute - Statistical Review of World Energy (2025) – with major processing by Our World in Data. “Electricity generation from gas” [dataset]. Ember, “Yearly Electricity Data Europe”; Ember, “Yearly Electricity Data”; Energy Institute, “Statistical Review of World Energy” [original data].
